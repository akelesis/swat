<template>
  <div class="dashboard-teacher">
      ...
      <section class="dashboard-teacher-first-section">
          ...
          <div class="dashboard-teacher-input-container">
              <input type="file" id="archive-file-input">
              <input type="file" id="image-file-input">
          </div>
          <textarea name="" placeholder="Insira aqui o resumo..." id="" cols="30" rows="10"></textarea>
...
.dashboard-teacher-input-container input, select {
    width: 24vw;
}
